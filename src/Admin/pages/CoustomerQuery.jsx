...
if(window.confirm(`are you sure u want to delete ${name}`)){
                  ...
                  {contact.map((contact, index) => (
                    <tr key={index} className="hover:bg-gray-100">
                      ...
                      <td className="px-2 py-2 border-b border-gray-200">
                        ...
                        <button className="bg-lime-600 hover:bg-lime-700 text-white font-bold py-2 px-2 rounded ml-2"><MdEdit /></button>
                       
                        <button className="bg-red-700 hover:bg-red-800 text-white font-bold py-2 px-2 rounded ml-2"><MdDelete  onClick={()=>deletequery(contact._id, contact.name)}/></button>
                      </td>
                    </tr>
                  ))}
                </tbody>
